#!/usr/bin/env python3
"""
Standalone test script for the ContextAgent with real APIs.

This script demonstrates the ContextAgent's decision-making process
with verbose logging, using actual Gemini and TMDB API calls.
"""
...
class ContextAgent:
    ...
    def __init__(self, verbose=True):
        ...
        if self.verbose:
            print("🤖 ContextAgent initialized with verbose logging (using REAL APIs)")
...
def main():
    """Test the Context Agent with sample data and questions using real APIs."""
    
    print("🎬 ContextAgent Test Suite (REAL APIs)")
    print("=" * 50)
    print("This demonstrates how the ContextAgent analyzes user questions")
    print("and decides what additional context to fetch from TMDB using")
    print("actual Gemini and TMDB API calls.\n")
    ...
    print("\n🧪 Testing Context Agent with sample questions...\n")
    ...
    print("🎉 Test completed! This shows how the agent makes intelligent")
    print("   decisions about what additional context to fetch based on user questions.")
